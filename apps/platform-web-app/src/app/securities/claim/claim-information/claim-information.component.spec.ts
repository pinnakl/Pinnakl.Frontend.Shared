...
import { MarketService, PublicIdentifierServiceStub, SecurityService, SecurityServiceStub, Utility } from '@pnkl-frontend/shared';
import { MarketServiceStub } from '@pnkl-frontend/shared';
import { ActivatedRouteStub, PublicIdentifierService, RouterStub } from '@pnkl-frontend/shared';
...
import { ClaimInformationHostComponent } from './claim-information-host.component.test';
import { ClaimInformationComponent } from './claim-information.component';

describe('ClaimInformationComponent (inline template)', () => {
  let comp: ClaimInformationHostComponent,
    fixture: ComponentFixture<ClaimInformationHostComponent>,
    page: ClaimInformationPage,
    testHelper: SecuritiesTestHelper;

  // async beforeEach
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ClaimInformationHostComponent, ClaimInformationComponent],
    ...
    activatedRouteInstance.setSnapShotUrl('claim');
  }));

  function createComponent(): void {
    fixture = TestBed.createComponent(ClaimInformationHostComponent);
    comp = fixture.componentInstance;

    testHelper = new SecuritiesTestHelper();
    page = new ClaimInformationPage();
...
class ClaimInformationPage {
  cancelBtn: HTMLButtonElement;
  saveBtn: HTMLButtonElement;

  addPageElements(
    comp: ClaimInformationHostComponent,
    fixture: ComponentFixture<ClaimInformationHostComponent>
  ): void {
    if (comp) {
